  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <button type="button" class="btn btn-warning btn-lg btn-block" id="showUnitTesting">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Show Entity Relationship Diagram (E.R.D)
      </button>

      </div>
      <div class="row">

          <button type="button" class="btn btn-block btn-lg btn-secondary" id="hideUnitTesting">
          <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> Hide Entity Relationship Diagram (E.R.D)
      </button>

      </div>
      <div class="row" id="unitTesting">
        <img src="media/ERD.jpg" height="100%" width="100%"/>
      </div>
